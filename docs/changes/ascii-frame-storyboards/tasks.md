...
- [x] 1.1 Storyboard: `SKILL.md` and the six frame templates, one glyph set, width 78, change map first, delta frame last, frames saved after confirmation
...
- [ ] 3.1 `rune validate`, `rune spec validate ascii-frame-storyboards`, `mdschema check --schema` on every new document, Vale, rumdl, typos
