...
Recorded proofs `docs/proofs/cast-player-in-proofs/` (pause and scene label under node) and `docs/proofs/proof-page-handover/` (the page generator on a five-scene cast), 2026-09-21.
