...
| CORE-0011 Verified Remote Execution | affirmed | deck CI pins action references by commit and verifies release binaries by SHA-256. Reusable workflow references and package installs remain compliance gaps |
