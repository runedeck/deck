...
- The ste skill provides a short command for SimplifiedTechnicalEnglish. It remains hidden from model invocation.
...
- The core skill schema now accepts `disable-model-invocation` and `user-invocable`.
