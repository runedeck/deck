...
You are turning something that already happened, or something the person can describe, into a skill another model can execute. Most of the material is usually already in front of you. The workflow below prevents duplicate questions.
...
- [ ] Put applicable optional Agent Skills fields in frontmatter: `license`, `compatibility`, `metadata`, and `allowed-tools`
