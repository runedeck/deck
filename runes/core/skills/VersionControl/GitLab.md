...
The asset URL must already be reachable when the release is created, because GitLab does not host attached files inline. It only links to them. Upload to the project's package registry or an external CDN first.
