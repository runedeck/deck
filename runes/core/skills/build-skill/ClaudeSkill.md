...
`rune install` deploys canonical skills into Claude Code's provider tree. Authors write canonical identity and instructions; assembly owns provider paths, namespace data, and provider extensions.

## CLAUDE.md

Global and project `CLAUDE.md` files carry standing Claude Code instructions outside skills. They are harness memory, not deck artifacts.
