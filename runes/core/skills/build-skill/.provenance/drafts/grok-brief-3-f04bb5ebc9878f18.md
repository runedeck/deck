...
ANSWER-ONLY. Do not use tools. Units for THIS batch: the three agent prompt templates and the schemas reference below, each as ONE unit. Same output format.
